          ...
          {flight ? (
            <>
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xs text-gray-400">{flight.flight_no}</span>
              </div>

              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide mb-0.5">Route</p>
              ...
              <div className="flex gap-6">
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Departs</p>
                  <p className="text-sm font-semibold text-gray-900 tabular-nums">
                    {formatTime(flight.depart)}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Arrives</p>
                  <p className="text-sm font-semibold text-gray-900 tabular-nums">
