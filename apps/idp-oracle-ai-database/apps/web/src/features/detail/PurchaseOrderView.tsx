...
export function PurchaseOrderView({ fields }: { fields: PurchaseOrderFields }) {
  const fmt = (n: number) =>
    ...
    <>
      <Card>
        ...
        <dl className="grid grid-cols-2 gap-3 text-sm">
          <Field label="PO number" value={fields.poNumber} />
          <Field label="Order date" value={fields.orderDate} />
          <Field label="Buyer" value={fields.buyer} />
          <Field label="Supplier" value={fields.supplier} />
          <Field label="Expected delivery" value={fields.expectedDeliveryDate ?? "—"} />
